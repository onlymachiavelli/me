...
const Hero = ({ ...props }) => {
  ...
  return (
    <main className="w-full h-auto">
      <div
        className="w-full h-auto lg:h-screen bg-no-repeat bg-cover bg-center"
        style={{
          backgroundImage: `url('${bck.src}')`,
        }}
      >
        <div className="w-full h-auto lg:h-screen bg-[#0000005d]  bg-opacity-50 backdrop-filter backdrop-blur-3xl">
          ...
          <div className="w-full h-auto flex items-center justify-center flex-col">
            ...
            <aside className="h-auto w-11/12 lg:w-1/2">
              <Lottie
                animationData={Astro}
                loop
                autoplay
