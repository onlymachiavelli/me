  ...
  return (
    <>
      <div className="w-full h-auto lg:h-screen flex items-center justify-center">
        ...
        <aside className="w-1/2 h-full grid content-center  ">
          ...
          <button className="w-48 border block m-left mt-10 border-white text-white px-6 py-3 hover:bg-white hover:text-gray-900 hover:border-transparent transition duration-300 ease-in-out text-sm font-thin">
            Say My name
          </button>
        </aside>
      </div>
